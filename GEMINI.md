# Working Note - Project Context & Guidelines (v0.4.0)
...
- **버전**: v0.4.0 (package.json, tauri.conf.json, Cargo.toml 동기화 필요)
...
- `src-tauri/tauri.conf.json`: 앱 설정 및 버전(0.4.0)

---
*Last Updated: 2026-03-26 (v0.4.0 Upgrade)*
